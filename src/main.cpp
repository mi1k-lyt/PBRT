...
int main()
{
    ...
    // --------------------
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "PBRT", NULL, NULL);
    ...
    float *data = stbi_loadf("/home/lyt/Desktop/LearnOpenGL/resources/textures/hdr/newport_loft.hdr", &width, &height, &nrComponents, 0);
